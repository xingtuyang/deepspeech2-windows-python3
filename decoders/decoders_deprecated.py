        ...
        for l in prefix_set_prev:
            ...
            for index in range(cutoff_len):
                ...
                if c == blank_id:
                    ...
                    l_plus = l + new_char.decode('utf-8')
...
def ctc_beam_search_decoder_batch(probs_split,
    ...
    for i, probs_list in enumerate(probs_split):
        # args = (probs_list, beam_size, vocabulary, cutoff_prob, cutoff_top_n, None, nproc)
        # results.append(pool.apply_async(ctc_beam_search_decoder, args))
        results.append(ctc_beam_search_decoder(probs_list, beam_size, vocabulary, cutoff_prob, cutoff_top_n, None, nproc))

    # pool.close()
    # pool.join()
    # beam_search_results = [result.get() for result in results]
    beam_search_results = results
